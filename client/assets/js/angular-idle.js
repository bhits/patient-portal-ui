      ...
      function($interval, $log, $rootScope, $document, Keepalive, LocalStorage, $window) {
        ...
        function setExpiry(date) {
          if (!date) {
            ...
            LocalStorage.remove('activiy');
          }else{
            LocalStorage.set('expiry', {id: id, time: date});
          }
        }

        function setActiveTime(){
          LocalStorage.set('activiy', {id: id, time: new Date().getTime()});
        }

        function getActiveTime() {
          var obj = LocalStorage.get('activiy');
          if(obj!== null){
            return obj && obj.time ? obj.time : null;
          }
        }
