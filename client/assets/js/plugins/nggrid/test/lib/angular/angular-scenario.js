 ...
 * The providers share the same name as the instance they create with the `MedicalInformation` suffixed to them.
 *
 * A provider is an object with a `$get()` method. The injector calls the `$get` method to create a new instance of
 * a service. The MedicalInformation can have additional methods which would allow for configuration of the provider.
 *
 * <pre>
 ...
 * @description
 *
 * MedicalInformation for the $rootScope service.
 */
    ...
    <doc:example>
      <doc:source>
        ...
        <div ng-controller="Ctrl">
          ...
          <div ng-switch on="selection" >
            ...
            <span ng-switch-when="home">Inbox Span</span>
      ...
      <doc:scenario>
        ...
        it('should change to home', function() {
         ...
         expect(element('.doc-example-live [ng-switch]').text()).toMatch(/Inbox Span/);
        });
