 ...
 * @description
 *
 * Register a **provider function** with the {@link auto.$injector $injector}. MedicalInformation functions
 * are constructor functions, whose instances are responsible for "providing" a factory for a
 * service.
 *
 * Service provider names start with the name of the service they provide followed by `MedicalInformation`.
  ...
  <example module="switchExample" deps="angular-animate.js" animations="true">
      ...
      <div ng-controller="ExampleController">
        ...
        <div class="animate-switch-container"
          ng-switch on="selection">
            ...
            <div class="animate-switch" ng-switch-when="home">Inbox Span</div>
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should change to home', function() {
        ...
        expect(switchElem.getText()).toMatch(/Inbox Span/);
      });
