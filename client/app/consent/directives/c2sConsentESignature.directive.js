(function () {
    ...
    angular
        .module('app.consent')
        .directive('c2sConsentESignature', c2sConsentESignature);

    function c2sConsentESignature() {
    ...
    function ConsentESignatureController($modal, consentService, utilityService) {
        ...
        /* @ngInject */
        function AuthenticateController($modalInstance, authenticationService, profileService) {
