    ...
    function mhcPopover() {
        ...
        function linkFunc(scope, element, attributes) {
            element.popover({
                ...
                template: '<div class="popover popover-width-medium"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title text-navy-blue custom-no-margin-top"></h3><div class="popover-content text-navbar-dark-blue"><p></p></div></div></div>'
            });
