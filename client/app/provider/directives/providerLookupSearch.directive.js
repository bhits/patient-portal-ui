...
(function() {
    ...
    angular
        .module("app.provider")
            .directive('providerLookupSearch', providerLookupResultDirective);
            ...
            function ProviderLookupSearchController($location, $element, $timeout, utilityService, providerService, notificationService) {
                ...
                var plsQueryParametersMaster = {usstate: "", city: "", zipcode: "", lastname: "", firstname: "", gender: "", phone: "", facilityname: ""};
